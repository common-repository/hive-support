...
/***/ "./src/frontend/components/AddTicket.jsx":
/*!***********************************************!*\
  !*** ./src/frontend/components/AddTicket.jsx ***!
  \***********************************************/
...
/* harmony import */ var _Tickets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Tickets */ "./src/frontend/components/Tickets.jsx");
/* harmony import */ var _default_fields__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./default-fields */ "./src/frontend/components/default-fields.js");
...
const AddTicket = () => {
  ...
  const [uploadFiles, setUplaodFiles] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [allTicketClick, setAllTicketClick] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  ...
  const uploadref = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const getTicketFields = async () => {
    const formdata = new FormData();
    formdata.append("action", "hive_lite_support_get_ticketfields_frontend");
    formdata.append("mailboxid", Number(shortcodes_data.mailbox_id));
    // const request = await fetch(window.hive_lite_support_client_script_object.ajaxurl, {
    const request = await fetch(hive_lite_support_client_script_object.ajaxurl, {
      method: "POST",
      body: formdata
    });
    ...
    if (response.success) {
      setLoading(false);
      let customFields = JSON.parse(response.data);
      let getTicketDefaultFields = [..._default_fields__WEBPACK_IMPORTED_MODULE_3__["default"], ...customFields];
      setFields(getTicketDefaultFields);
    }
  };
  const TicketFormData = {
    action: "add_ticket_from_customer_panel",
    mailbox: Number(window.shortcodes_data.mailbox_id)
  };
  const getCurrentSubmit = action => {
    let currentSubmission = {
      mailbox: shortcodes_data.mailbox_id,
      action: action
    };
    return currentSubmission;
  };
  const handleFilesChange = e => {
    setUplaodFiles(e.target.files);
  };
  ...
  const handleSubmit = async e => {
    ...
    Object.entries(currentSubmission).forEach(function (_ref) {
      let [key, value] = _ref;
      formdata.append(key, value);
    });
    const requiredFields = fields.filter(field => field.fieldrequire);
    const missingFields = requiredFields.filter(field => !formData[field.metakey]);
    if (missingFields.length > 0) {
      missingFields.forEach((field, index) => {
        setFormerror(prevstate => ({
          ...prevstate,
          [field.metakey]: field.errormsg ? field.errormsg : `${field.label} can't be empty`
        }));
      });
      return;
    }
    ...
    for (let [key, value] of formdata.entries()) {
      if (key !== "action" && key !== "mailbox") {
        const fieldstrip = fields.find(field => field.metakey == key);
        formdata.set(key, JSON.stringify({
          fieldvalue: fieldstrip.type == "checkbox" ? formData[key] : value,
          fieldlabel: fieldstrip.label
        }));
      }
    }
    ...
    try {
      ...
      if (response.success) {
        ...
        if (response.data.notice_type == "success") {
          setAllTicketClick(true);
          (0,_utils_utils__WEBPACK_IMPORTED_MODULE_4__.fireNotify)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Ticket is successfully added!", "hive-support"), "success");
        }
      }
    } catch (error) {
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_4__.fireNotify)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Something went wrong", "hive-support"), "error");
    }
  };
  const handleXSubmit = async e => {
    e.preventDefault();
    const formdata = new FormData(form.current);
    formdata.append("action", "add_ticket_from_customer_panel");
    formdata.append("mailbox", Number(window.shortcodes_data.mailbox_id));
    const requiredFields = fields.filter(field => field.fieldrequire);
    const missingFields = requiredFields.filter(field => !formData[field.metakey]);
    if (missingFields.length > 0) {
      missingFields.forEach((field, index) => {
        //setFormerror({ ...formError, [field.metakey]: `${field.label} can't be empty` });
        setFormerror(prevstate => ({
          ...prevstate,
          [field.metakey]: field.errormsg ? field.errormsg : `${field.label} can't be empty`
        }));
    ...
    const response = await fetch(hive_lite_front.ajaxurl, {
      method: "POST",
      body: formdata
    });
  ...
  const handleFieldChange = e => {
    ...
    let newvalue = value;
    if (type === "checkbox") {
      const checkbox_values = formData[name] || [];
      newvalue = checked ? [...checkbox_values, value] : checkbox_values.filter(val => val !== value);
    }
    setFormData({
      ...formData,
      [name]: newvalue
  ...
  const Loader = () => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      class: "hive_lite_support_loader"
    }));
  };
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    getTicketFields();
    return () => {
      setAllTicketClick(false);
      setSubmitLoading(false);
    };
  }, []);
  if (allTicketClick) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Tickets__WEBPACK_IMPORTED_MODULE_2__["default"], null);
  }
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    ref: form
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_form"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_form_header"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Create New Ticket", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    class: "show_tickets",
    onClick: () => setAllTicketClick(true)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("All Tickets", "hive-support"))), loading ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Loader, null) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_form_body"
  }, Array.isArray(fields) && fields.map((field, index) => {
    if (field.type == "text") {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_support_single_form_element"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
        className: "hive_lite_support_element_label",
        htmlFor: "hive_lite_support_field_id_sedbrgclo"
      }, field.label), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_support_element_field_main"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
        id: "hive_lite_support_field_id_sedbrgclo",
        type: "text",
        name: field.metakey,
        onChange: handleFieldChange
      })), formError[field.metakey] && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        style: {
          color: "red",
          marginTop: "4px",
          fontSize: "16px",
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: "hive_lite_support_element_label",
        htmlFor: "hive_lite_support_field_id_q0hj5vgtb"
      }, field.label), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_support_element_field_main"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
        name: field.metakey,
        onChange: handleFieldChange
      }, field.options.map(option => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
        value: option.value
      }, option.value)))), formError[field.metakey] && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        style: {
          color: "red",
          marginTop: "4px",
          fontSize: "16px",
      ...
      }, Array.isArray(field.options) && field.options.map(option => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
        className: "radio_item"
      }, option.value, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
        type: "radio",
        value: option.value,
        className: "radio_zpmtr4e3v",
        name: field.metakey,
        onChange: handleFieldChange
      ...
      const isSupportedImage = file => {
        const supportedImageTypes = ["jpeg", "png", "gif", "jpg", "webp"];
        return supportedImageTypes.some(type => file.type.includes(type));
      };
      if (uploadFiles) {
        for (let i = 0; i < uploadFiles.length; i++) {
          console.log("Filename", uploadFiles[i].name);
          if (isSupportedImage(uploadFiles[i])) {
            const img = URL.createObjectURL(uploadFiles[i]);
            uploadfiledata.push({
              type: "image",
              img_src: img
            });
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "flex-wrap media-upload-preview"
      }, Array.isArray(uploadfiledata) && uploadfiledata.map((file, index) => {
        if (file.img_src) {
          ...
          return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("This is file name", "hive-support"));
        }
        console.log(`file info admin side.`);
        console.log(file);
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "ticket_media_upload",
        ...
        d: "M16.0799 10.42L9.89992 16.61C9.08973 17.33 8.03506 17.7132 6.95164 17.6814C5.86821 17.6495 4.83792 17.2048 4.07149 16.4384C3.30506 15.672 2.86043 14.6417 2.82853 13.5582C2.79664 12.4748 3.1799 11.4202 3.89992 10.61L11.8999 2.60997C12.3775 2.15627 13.0112 1.9033 13.6699 1.9033C14.3287 1.9033 14.9623 2.15627 15.4399 2.60997C15.9053 3.08156 16.1662 3.71744 16.1662 4.37997C16.1662 5.0425 15.9053 5.67838 15.4399 6.14997L8.53992 13.04C8.47163 13.1135 8.38952 13.1729 8.29829 13.2147C8.20706 13.2565 8.10849 13.2799 8.0082 13.2836C7.90791 13.2874 7.80788 13.2713 7.7138 13.2363C7.61973 13.2014 7.53346 13.1483 7.45992 13.08C7.38638 13.0117 7.32701 12.9296 7.2852 12.8383C7.24339 12.7471 7.21995 12.6485 7.21624 12.5483C7.21253 12.448 7.2286 12.3479 7.26355 12.2539C7.29849 12.1598 7.35163 12.0735 7.41992 12L12.5499 6.87997C12.7382 6.69166 12.844 6.43627 12.844 6.16997C12.844 5.90367 12.7382 5.64827 12.5499 5.45997C12.3616 5.27166 12.1062 5.16588 11.8399 5.16588C11.5736 5.16588 11.3182 5.27166 11.1299 5.45997L5.99992 10.6C5.74322 10.8547 5.53948 11.1577 5.40045 11.4915C5.26141 11.8253 5.18983 12.1834 5.18983 12.545C5.18983 12.9066 5.26141 13.2646 5.40045 13.5984C5.53948 13.9323 5.74322 14.2353 5.99992 14.49C6.52429 14.9895 7.22072 15.2681 7.94492 15.2681C8.66911 15.2681 9.36554 14.9895 9.88992 14.49L16.7799 7.58997C17.5748 6.73692 18.0075 5.60864 17.987 4.44283C17.9664 3.27703 17.4941 2.16472 16.6696 1.34024C15.8452 0.515759 14.7329 0.0434872 13.5671 0.0229179C12.4012 0.00234858 11.273 0.435088 10.4199 1.22997L2.41992 9.22997C1.34111 10.4248 0.764944 11.9898 0.811449 13.5989C0.857954 15.2081 1.52355 16.7372 2.66955 17.8677C3.81556 18.9983 5.35359 19.643 6.9632 19.6677C8.57281 19.6923 10.1299 19.0949 11.3099 18L17.4999 11.82C17.5932 11.7267 17.6671 11.616 17.7176 11.4942C17.768 11.3724 17.794 11.2418 17.794 11.11C17.794 10.9781 17.768 10.8475 17.7176 10.7257C17.6671 10.6039 17.5932 10.4932 17.4999 10.4C17.4067 10.3067 17.296 10.2328 17.1742 10.1823C17.0523 10.1318 16.9218 10.1059 16.7899 10.1059C16.6581 10.1059 16.5275 10.1318 16.4057 10.1823C16.2838 10.2328 16.1732 10.3067 16.0799 10.4V10.42Z",
        fill: "#1F8FEB"
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "upload_text"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Drag and drop or Click here to upload file", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
        ref: uploadref,
        type: "file",
        style: {
          display: "none"
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: "hive_lite_support_element_label",
        htmlFor: "hive_lite_support_field_id_56b179j4j"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Message", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_support_element_field_main"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("textarea", {
        name: field.metakey,
        onChange: handleFieldChange,
        id: "hive_lite_support_field_id_56b179j4j",
        rows: 4
      })), formError[field.metakey] && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        style: {
          color: "red",
  ...
  }, submitLoading ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "submitting_loader"
  }) : "Submit"))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AddTicket);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _AddTicket__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddTicket */ "./src/frontend/components/AddTicket.jsx");
/* harmony import */ var _Tickets__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Tickets */ "./src/frontend/components/Tickets.jsx");
/* harmony import */ var _Checkbox_TestForward__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Checkbox/TestForward */ "./src/frontend/components/Checkbox/TestForward.jsx");
/* harmony import */ var _Checkbox_RefChild__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Checkbox/RefChild */ "./src/frontend/components/Checkbox/RefChild.jsx");
...
const App = () => {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Tickets__WEBPACK_IMPORTED_MODULE_3__["default"], null));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (App);

/***/ }),

/***/ "./src/frontend/components/Checkbox/RefChild.jsx":
/*!*******************************************************!*\
  !*** ./src/frontend/components/Checkbox/RefChild.jsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const RefChild = _ref => {
  ...
  const modifiedChildren = Array.from(text).map((char, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index
  }, char));
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, modifiedChildren);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RefChild);

/***/ }),

/***/ "./src/frontend/components/Checkbox/TestForward.jsx":
/*!**********************************************************!*\
  !*** ./src/frontend/components/Checkbox/TestForward.jsx ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _RefChild__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./RefChild */ "./src/frontend/components/Checkbox/RefChild.jsx");



const TestForward = () => {
  const pref = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    ref: pref
  }, "jkjk"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_RefChild__WEBPACK_IMPORTED_MODULE_2__["default"], {
    elm: pref
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TestForward);

/***/ }),

/***/ "./src/frontend/components/SingleTicket.jsx":
/*!**************************************************!*\
  !*** ./src/frontend/components/SingleTicket.jsx ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const SingleTicket = _ref => {
  let {
    id
  } = _ref;
  console.log(id);
  const uploadref = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const [singleticket, setSingleTicket] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({});
  const [ticketReplies, setTicketReplies] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const [allticketclick, setAllTicketClick] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [uploadFiles, setUplaodFiles] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [replayMessage, setReplayMessage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [submitLoading, setSubmitLoading] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const handleClick = e => {
    e.stopPropagation();
    const newstate = renderTest.map(elm => {
      return elm;
    });
    setrenderTest(newstate);
  };
  const handleUploadClick = () => {
    uploadref.current.click();
  };
  ...
  Array.prototype.filterForeach = function (callback) {
    let currentindex;
    for (let i = 0; i < this.length; i++) {
      if (callback(this[i])) {
        return this[i];
  ...
  const handleAddReplay = async e => {
    ...
    formdata.append("action", "hive_lite_support_add_replay_from_frontend");
    formdata.append("replaymessage", replayMessage);
    formdata.append("ticketid", Number(id));
    formdata.append("person_id", window.shortcodes_data.current_user.ID);
    const request = await fetch(window.hive_lite_support_client_script_object.ajaxurl, {
      method: "POST",
      body: formdata
    });
  ...
  //Caching is important for memorizing datat that doiesa not often change
  ...
  const getticketandreplies = async () => {
    const formdata = new FormData();
    formdata.append("ticketid", Number(id));
    formdata.append("action", "hive_lite_support_get_ticket_replies");
    const request = await fetch(window.hive_lite_support_client_script_object.ajaxurl, {
      method: "POST",
      body: formdata
    });
    const response = await request.json();
    setLoading(false);
    setSingleTicket(response.data.tickets);
    setTicketReplies(response.data.ticket_replies);
  };
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    getticketandreplies();
  }, []);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "hive_lite_support_client_thread",
    style: {
      display: "block"
    }
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_header"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", {
    onClick: clousreFunction()
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Support Portal", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "show_tickets",
    onClick: () => setAllTicketClick(true)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("All Tickets", "hive-support"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_form_body hive_lite_support_thread_reply_form"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_single_form_element hive_lite_support_thread_reply_msg_field"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "hive_lite_support_element_label"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Message", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_element_field_main"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("textarea", {
    rows: 4,
    ...
    if (file.img_src) {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("This is file name", "hive-support"));
    }
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "ticket_media_upload",
    onClick: handleUploadClick
    ...
    className: "upload_text"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Drag and drop or Click here to upload file", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    ref: uploadref,
    type: "file",
    style: {
      display: "none"
    ...
    className: "reply btn-extra-style",
    onClick: handleAddReplay
  }, submitLoading ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "submitting_loader"
  }) : "Reply")))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_items"
  }, Array.isArray(ticketReplies) && ticketReplies.map((reply, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item ok",
    key: index
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item_header"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: "http://1.gravatar.com/avatar/1aedb8d9dc4751e229a335e371db8058?s=96&d=mm&r=g"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item_header_details"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: "#"
  }, reply.useobject.data.display_name), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: `response_by prio-response ${window.shortcodes_data.current_user.ID == reply.useobject.ID ? "hs-my--message" : ""}`
  }, window.shortcodes_data.current_user.ID == reply.useobject.ID ? "You" : reply.user_role == "administrator" ? "Admin" : reply.user_role == "hive_support_staff" ? "Agent" : "Customer"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "response_at"
  }, moment__WEBPACK_IMPORTED_MODULE_3___default()(reply.created_at).fromNow()))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item_body"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    dangerouslySetInnerHTML: {
      __html: reply.content
    }
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "reply_thraed_uploaded_files"
  }, reply.media_urls && Array.isArray(JSON.parse(reply.media_urls)) && JSON.parse(reply.media_urls).map((media, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "button_file_item",
    key: index
  }, media.filepath.split(".").filter(Boolean).pop() == "jpg" || media.filepath.split(".").filter(Boolean).pop() == "jpeg" || media.filepath.split(".").filter(Boolean).pop() == "png" ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
    fill: "none",
  ...
  }, media.filename))))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item_header"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: "http://1.gravatar.com/avatar/1aedb8d9dc4751e229a335e371db8058?s=96&d=mm&r=g"
    ...
    href: "#"
  }, singleticket.customer_name), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "response_by hs-my--message"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("You", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "response_at"
  }, moment__WEBPACK_IMPORTED_MODULE_3___default()(singleticket.created_at).fromNow()))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_thread_item_body"
    ...
    class: "hs-ticket-content-title"
  }, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Subject", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    class: "hs-ticket-content-value"
  }, singleticket.title)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    class: "hs-ticket-content-title"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Message", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    class: "hs-ticket-content-value"
  }, singleticket.content)), Array.isArray(JSON.parse(singleticket.ticket_fields)) && JSON.parse(singleticket.ticket_fields).map(field => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    class: "hs-ticket-content-title"
  }, field.label), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    class: "hs-ticket-content-value"
  }, field.value))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "reply_thraed_uploaded_files"
  }, singleticket.media_urls && Array.isArray(JSON.parse(singleticket.media_urls)) && JSON.parse(singleticket.media_urls).map((media, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "button_file_item",
    key: index
  }, media.filepath.split(".").filter(Boolean).pop() == "jpg" || media.filepath.split(".").filter(Boolean).pop() == "jpeg" || media.filepath.split(".").filter(Boolean).pop() == "png" ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: "20",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SingleTicket);

/***/ }),

/***/ "./src/frontend/components/Tickets.jsx":
/*!*********************************************!*\
  !*** ./src/frontend/components/Tickets.jsx ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _AddTicket__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AddTicket */ "./src/frontend/components/AddTicket.jsx");
/* harmony import */ var _SingleTicket__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SingleTicket */ "./src/frontend/components/SingleTicket.jsx");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__);
...
const Tickets = () => {
  // console.log(window.shortcodes_data.current_user);
  const [tickets, setTickets] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [newTicketClick, setNewTicketClick] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [selectedId, setSelectedId] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const defaultAvatar = `${hive_lite_front.site_url}/wp-content/plugins/HiveSupportPro/assets/img/agents/user_default.png`;
  const currentUserId = Number(window.shortcodes_data.current_user.ID);
  if (!currentUserId) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, "Please, Login to see your tickets."));
  }
  const handleSelectId = id => {
    setSelectedId(id);
    const formdata = new FormData();
    formdata.append("action", 'hive_lite_support_set_customer_seen_status');
    formdata.append("ticket_id", id);
    const request = fetch(window.hive_lite_support_client_script_object.ajaxurl, {
      method: "POST",
      body: formdata
    });
  };
  const getTicketByInbox = async () => {
    const formdata = new FormData();
    formdata.append("action", "get_tickets_by_mailbox");
    formdata.append("mailbox", Number(window.shortcodes_data.mailbox_id));
    formdata.append("customerid", currentUserId);
    const response = await fetch(window.hive_lite_support_client_script_object.ajaxurl, {
      method: "POST",
      body: formdata
    });
    const result = await response.json();
  ...
  if (selectedId) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_SingleTicket__WEBPACK_IMPORTED_MODULE_4__["default"], {
      id: selectedId
    });
  }
  if (newTicketClick) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AddTicket__WEBPACK_IMPORTED_MODULE_3__["default"], null);
  }
  if (loading) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "w-full h-screen flex justify-center items-center",
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "hive_lite_support_client_tickets",
    style: {
      borderColor: "var(--qs-dm-border)",
      color: "var(--qs-dm-text)",
      boxShadow: "none",
      display: "block"
    }
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_header",
    style: {
      borderColor: "var(--qs-dm-border)",
      color: "var(--qs-dm-text)",
      boxShadow: "none"
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Support Portal", "hive-support")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "show_form",
    onClick: () => setNewTicketClick(true),
    style: {
      borderColor: "var(--qs-dm-border)",
      color: "white",
      boxShadow: "none",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("New Ticket", "hive-support"))), Array.isArray(tickets) && tickets.length > 0 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_items",
    style: {
      borderColor: "var(--qs-dm-border)",
      color: "var(--qs-dm-text)",
      boxShadow: "none"
    }
  }, tickets.map((ticket, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_item",
    key: index
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_item_body"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: defaultAvatar
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_item_body_details"
  }, ticket.customer_seen_status == 'new_reply' ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: `ticket-watch-status ${ticket.customer_seen_status}`
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('New Reply Added', 'hive-support')) : '', (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    onClick: () => handleSelectId(ticket.id)
  }, ticket.title, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "#", ticket.id)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, ticket.content))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_item_footer"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Last Update:", "hive-support"), " "), " ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, " ", moment__WEBPACK_IMPORTED_MODULE_2___default()(ticket.updated_at).fromNow())), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Status:", "hive-support"), " "), " ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, " ", ticket.ticket_status, " ")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Ticket Created:", "hive-support"), " "), " ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, " ", ticket.created_at.split(" ")[0], " "))))))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hive_lite_support_client_tickets_empty",
    style: {
      display: "flex"
    }
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("You have no previously created tickets.", "hive-support")));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Tickets);

/***/ }),

/***/ "./src/frontend/components/default-fields.js":
/*!***************************************************!*\
  !*** ./src/frontend/components/default-fields.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const ticketDefaultFields = [{
  type: "text",
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Subject", "hive-support"),
  errormsg: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Please provide the subject.", "hive-support"),
  metakey: "hs_ticket_title",
  class: "",
  inboxid: [],
  fieldrequire: true
}, {
  type: "textarea",
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Message", "hive-support"),
  errormsg: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Please share your problem in details.", "hive-support"),
  metakey: "hs_ticket_message",
  class: "",
  inboxid: [],
  fieldrequire: true
}, {
  type: "dropdown",
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Select Priority", "hive-support"),
  errormsg: "",
  metakey: "hs_ticket_priority",
  class: "",
  inboxid: [],
  options: [{
    value: "Normal",
    optionmeta: "b7745b03-efd0-4203-8a2d-25aa2c6d1191"
  }, {
    value: "High",
    optionmeta: "e7c82888-4fdf-409f-a451-cbe7b455ddd0"
  }, {
    value: "Urgent",
    optionmeta: "d4e5f161-c678-4997-ae98-897db2f98914"
  }, {
    value: "Low",
    optionmeta: "f72b5036-7d9b-4f08-ac94-6e8c51a195b3"
  }, {
    value: "Medium",
    optionmeta: "b1572f31-3c70-4b52-b3dd-78022335894d"
  }, {
    value: "Critical",
    optionmeta: "b1572f31-7c70-4b40-b3dd-857477854774"
  }],
  fieldrequire: false
}, {
  type: "media",
  label: "",
  errormsg: "",
  metakey: "hs_ticket_media",
  class: "",
  inboxid: [],
  fieldrequire: false
}];
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ticketDefaultFields);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fireNotify": () => (/* binding */ fireNotify)
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
const fireNotify = function (message) {
  let type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  let position = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "bottom-right";
  switch (type) {
    case "error":
      return react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.error((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_toasts"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_tosats_icon"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "text-2xl text-red-400"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_icons_hi__WEBPACK_IMPORTED_MODULE_3__.HiXCircle, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "toast-type"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Error", "hive-support"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "hive_lite_toasts_message"
      }, message)), {
        position,
        hideProgressBar: true
      });
    case "info":
      return react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.info((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_toasts"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_tosats_icon"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "text-2xl text-blue-400"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_icons_hi__WEBPACK_IMPORTED_MODULE_3__.HiInformationCircle, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "toast-type"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Info", "hive-support"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "hive_lite_toasts_message"
      }, message)), {
        position,
        hideProgressBar: true
    ...
    case "warning":
      return react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.warning((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_toasts"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_tosats_icon"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "text-2xl text-yellow-400"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_icons_hi__WEBPACK_IMPORTED_MODULE_3__.HiExclamation, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "toast-type"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Warning", "hive-support"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "hive_lite_toasts_message"
      }, message)), {
        position,
        hideProgressBar: true
    ...
    default:
      return react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.success((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_toasts"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "hive_lite_tosats_icon"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "text-2xl text-emerald-400"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_icons_hi__WEBPACK_IMPORTED_MODULE_3__.HiCheckCircle, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
        className: "toast-type"
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Success", "hive-support"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "hive_lite_toasts_message"
      }, message)), {
        position,
        hideProgressBar: true
...
(() => {
/*!**********************************!*\
  !*** ./src/frontend/customer.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_App__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/App */ "./src/frontend/components/App.jsx");



const root = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createRoot)(document.getElementById("customer_portal"));

// alert('customer_portal is loaded');
// alert('customer_portal is loaded');

function customer_portal() {
  root.render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_App__WEBPACK_IMPORTED_MODULE_1__["default"], null));
}
document.addEventListener('DOMContentLoaded', () => {
  const customer = document.getElementById("customer_portal");
  if (customer) {
    customer_portal();
  }
});
...
/******/ })()
;
//# sourceMappingURL=customer_portal.js.map